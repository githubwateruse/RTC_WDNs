# -*- coding: utf-8 -*-
"""
Created on Thu Dec 15 07:57:10 2022
...
def GA_Evaluation_multipool(header_write):

    
    path = Header_base + 'LHS sample results/LhsRandom_results_for_'+ header_write +'_0.xlsx'   #设置路径
    ...
    for i in range (colNum_S):
        ...
        path_read = " " # the path of the pump solution results
        path_solution = path_read + "GA_" +header_write + "_0/Deamnd Scenario_" + str(i) + "_pump solution.xlsx"
        workbook_solution = xlrd.open_workbook(path_solution)
        data_sheet_solution = workbook_solution.sheet_by_index(0) 
        Specific_GA_solution = data_sheet_solution.row_values(299)
        ...
        Total_costs, Pump_solutions, Energy_power, MIN_node_pressure, Tank1_level, Tank2_level, Tank3_level = GA_Evaluation(Specific_GA_solution, demand_scenario)
...
if __name__ == "__main__":
    ...
    for x in Header_write:
        ...
        GA_Evaluation_multipool(header_write)
