...
def Main_Loop_Training(State_vector, number, seed):
    ...
    for ep in range (args.max_train_episodes):
        ...
        for period in range(EP_LEN):
            ...
            Observation = np.append(np.append(Standard_tanklevel, Standard_demand_observation), action_pre)
            ...
            Observation_ = np.append(np.append(Nx_Sd_tanklevel_Observation, Nx_Sd_demand_observation), action_current)
...
if __name__ == "__main__":
    ...
    # state vector
    State_vector = "SV2" # "SV1","SV2", "SV3", "SV4", "SV5"
