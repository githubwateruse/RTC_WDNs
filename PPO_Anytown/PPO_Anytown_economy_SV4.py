...
"""
SV4的参考代码；SV4的参考代码；SV4的参考代码
Observation = np.append(np.append(np.append(Standard_tanklevel, Standard_demand_observation), Tone_hot), action_pre)

Observation_ = np.append(np.append(np.append(Nx_Sd_tanklevel_Observation, Nx_Sd_demand_observation), T_one_hot), action_current)
"""
...
if __name__ == "__main__":
    ...
    # state vector
    State_vector = "SV4" # "SV1","SV2", "SV3", "SV4", "SV5"
