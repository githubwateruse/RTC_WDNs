...
np.random.seed(1)
lhsamplesize = 250 # the number of training scnarios (i.e. 150) + the number of testing scenarios (i.e. 100)
Cv = 0.5
...
tk.open(ENpro, "D_town_mod_1h.inp", "D_town_mod_1h.rpt", "")
...
import xlsxwriter 
workbook_training = xlsxwriter.Workbook('LHS sample results_Dtown/LhsRandom_results_for_training.xlsx')
...
workbook_testing = xlsxwriter.Workbook('LHS sample results_Dtown/LhsRandom_results_for_testing.xlsx')
